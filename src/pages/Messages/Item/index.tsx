...
import { ViewStyled, ViewStyledTwo,ParagraphStyled,TitleStyled,
  EditButton, TitleBtn, EditButtonTwo, TitleBtnTwo } from './styles'
  ...
  return (
    <ViewStyled>
      <ViewStyledTwo>
        ...
        <EditButton onPress={() => navigation.navigate('MessagesEdit', { item })}>
